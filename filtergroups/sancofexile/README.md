# sancofexile
## Last updated September 11th Season 13 - build 262

## Filters
* Standard: Sancofexile's all-in-one balanced filter. The standard recommendation for most players. [Sancofexile.filter]
* Class — Amazon: Class filter tuned for Amazon. Shows Amazon-relevant items and crafting bases at higher filter levels. [Sancofexile_Crafting_Amazon_Focused.filter]
* Class — Assassin: Class filter tuned for Assassin. Shows Assassin-relevant items and crafting bases at higher filter levels. [Sancofexile_Crafting_Assassin_Focused.filter]
* Class — Barbarian: Class filter tuned for Barbarian. Shows Barbarian-relevant items and crafting bases at higher filter levels. [Sancofexile_Crafting_Barbarian_Focused.filter]
* Class — Druid: Class filter tuned for Druid. Shows Druid-relevant items and crafting bases at higher filter levels. [Sancofexile_Crafting_Druid_Focused.filter]
* Class — Necromancer: Class filter tuned for Necromancer. Shows Necromancer-relevant items and crafting bases at higher filter levels. [Sancofexile_Crafting_Necromancer_Focused.filter]
